...
> Phase 4 · part 1 is the Ralph-loop Coder (`LOOP_ENGINE_CODER=ralph`); all default
> off/`classic`. Phase 4 · part 2 (declarative generators) and Phase 5 remain sketched.
