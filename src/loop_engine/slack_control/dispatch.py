...
loop-engine run from a parsed Slack `/agent-run` command, and (T5) of a
...
from loop_engine.tools.slack_io import send_thread_message
from loop_engine.tools.state_io.reader import load_state
