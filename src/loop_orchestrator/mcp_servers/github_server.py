...
Run as: `python -m loop_orchestrator.mcp_servers.github_server`
"""

from mcp.server.fastmcp import FastMCP

from loop_orchestrator.tools.repo_io import clone_repo as _clone_repo
from loop_orchestrator.tools.repo_io import create_branch as _create_branch
from loop_orchestrator.tools.repo_io import create_repository as _create_repository
from loop_orchestrator.tools.repo_io import open_pr as _open_pr

mcp = FastMCP("loop-orchestrator-github")
