...
from loop_orchestrator.core.notify import LifecycleEvent, NoOpNotifier, Notifier
from loop_orchestrator.tools.env_compat import getenv_compat
from loop_orchestrator.tools.slack_io.format import format_event
...
def build_notifier_from_env() -> Notifier:
    ...
    `LOOP_ORCHESTRATOR_SLACK_BOT_TOKEN` and `LOOP_ORCHESTRATOR_SLACK_CHANNEL` are set."""
